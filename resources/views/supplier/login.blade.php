        ...
        <div class="container">
          <div class="row">
            <div class="col-md-5"  style="margin-bottom:20px;">
              <h1>Join Holirent to be a Supplier</h1>
            ...
            <div class="col-md-5 offset-sm-2">
              <div class="login-form">
                <div class="header-login">
                  <h3>Login</h3>
                  <p>Login to Start Your Partisipation</p>
                </div>
                <div class="main-login">
                    <form method="POST" action="{{route('supplier.login')}}">
                      ...
                      <button type="submit" class="btn btn-lg btn-block" style="background-color:#343a40;color:white;"tabindex="4">
                        Login
                      </button>
                    </form>
                </div>
                <div class="footer">
                  ...
                  <a class="btn btn-outline-success btn-lg btn-block" href="{{route('supplier.view.regis')}}"tabindex="4">
                        Daftar
                  </a>
                </div>
              </div>
