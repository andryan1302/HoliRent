        ...
        <div class="table-responsive">
          <table class="table table-striped text-center" style="padding:0px 0px">
            ...
            <tr>
              ...
              <td>{{$datas->total}}</td>
              <td>{{$datas->status}}</td>
              <td>@if($datas->status === "Berhasil")<a href="#" class="barcode" no="{{$loop->iteration}} "data-toggle="modal" data-target="#modal-bp">Barcode</a> @endif</td>
              <div class="data-qr{{$loop->iteration}}" style="display:none">
              
              <?php echo DNS2D::getBarcodeHTML($datas->no_transaksi, 'QRCODE',20,20); ?>
              </div>
            </tr>
            @endforeach
          </table>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h4 class="modal-title text-center w-100 font-weight-bold" id="exampleModalLabel" style="font-family: 'Roboto';">QR CODE</h4>
